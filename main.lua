...
function startScreenHandler()
	...
	Runtime:addEventListener("playBtnTouched", function(e)
		...
		if canPlay then
			...
			Runtime:removeEventListener("infoBtnTouched")
	...
	Runtime:addEventListener("infoBtnTouched", function(e)
		canPlay = false
		infoScreen:show()
		infoScreen:toFront()

		Runtime:addEventListener("backBtnITouched", function(e)
			infoScreen:hide()
			canPlay = true
		end)
	end)
